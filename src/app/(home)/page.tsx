...
export default async function Home() {
  return (
    <section className="mb-422 relative flex w-full flex-col items-center justify-center gap-7 px-4 py-[12vh] pt-[10vh] sm:pt-[10vh] md:px-8">
      <svg
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 inset-x-0 inset-y-[0%] h-[calc(100vh-64px)] w-full skew-y-[300] fill-gray-400/30 stroke-gray-400/30 [mask-image:radial-gradient(500px_circle_at_center,white,transparent)]"
      >
        <defs>
          <pattern
            id=":rt2:"
      ...
      <div className="sm:hidden">
        ...
        >
          Post and Manage Viral Twitter Threads for Free
        </Balancer>{" "}
      </div>
      <Balancer className="max-w-[40rem] px-6 text-center leading-normal text-muted-foreground sm:leading-8">
        Chose your writting style and let us handle the rest
      </Balancer>
      <GenerateForm />
    </section>
  )
